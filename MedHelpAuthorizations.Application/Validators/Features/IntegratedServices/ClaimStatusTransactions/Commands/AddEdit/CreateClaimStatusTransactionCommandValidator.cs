...
using MedHelpAuthorizations.Application.Features.IntegratedServices.ClaimStatus.ClaimStatusTransactions.Commands.Create;
...
{
    public class CreateClaimStatusTransactionCommandValidator : AbstractValidator<CreateClaimStatusTransactionCommand>
    {
        public CreateClaimStatusTransactionCommandValidator(IStringLocalizer<CreateClaimStatusTransactionCommandValidator> localizer)
        {

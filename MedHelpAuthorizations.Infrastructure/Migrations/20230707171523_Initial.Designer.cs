...
namespace MedHelpAuthorizations.Infrastructure.Migrations
{
    ...
    [Migration("20230707171523_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.Catalog.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.Catalog.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.Client", b =>
                {
                    ...
                    b.Property<int?>("ClientLevelKpisId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.ClientEmployeeDepartment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ClientEmployeeDepartment");
                });

            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.ClientEmployeeKpi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("AverageDailyClaimsWorkedKpi")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("MonthlyCashCollectionsKpi")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.ClientKpi", b =>
                {
                    ...
                    b.Property<int?>("CodingDenialPercentage")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("DemographicDenialPercentage")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.ClientLocationServiceType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClientLocationId", "AuthTypeId", "ClientId")
                        .IsUnique();
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.ClientReportFilter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ClientReportFilters", "dbo");
                });
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.Employee", b =>
                {
                    ...
                    b.Property<string>("AlphabeticalSplit")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ClaimCountRequired")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.EmployeeClaimStatusExceptionReasonCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EmployeeClaimStatusExceptionReasonCategories");
                });
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.EmployeeDepartment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.EmployeeLevel", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.IntegratedServices.ClientInsuranceRpaConfiguration", b =>
                {
                    ...
                    b.HasIndex("ClientInsuranceId", "RpaInsuranceId", "TransactionTypeId", "AuthTypeId", "ExternalId")
                        .IsUnique()
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.Catalog.Product", b =>
                {
                    b.HasOne("MedHelpAuthorizations.Domain.Entities.Catalog.Brand", "Brand")
                        .WithMany()
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.ClientEmployeeDepartment", b =>
                {
                    ...
                    b.HasOne("MedHelpAuthorizations.Domain.Entities.EmployeeClient", "EmployeeClient")
                        .WithMany("ClientEmployeeDepartments")
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.ClientKpi", b =>
                {
                    b.HasOne("MedHelpAuthorizations.Domain.Entities.Client", "Client")
                        .WithOne("ClientKpi")
                        .HasForeignKey("MedHelpAuthorizations.Domain.Entities.ClientKpi", "ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.Employee", b =>
                {
                    b.HasOne("MedHelpAuthorizations.Domain.Entities.EmployeeLevel", "EmployeeLevel")
                        .WithMany()
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.EmployeeClaimStatusExceptionReasonCategory", b =>
                {
                    ...
                    b.HasOne("MedHelpAuthorizations.Domain.Entities.EmployeeClient", "EmployeeClient")
                        .WithMany("EmployeeClaimStatusExceptionReasonCategories")
                        .HasForeignKey("EmployeeClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MedHelpAuthorizations.Domain.Entities.Employee", null)
                        .WithMany("EmployeeClaimStatusExceptionReasonCategories")
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.Employee", b =>
                {
                    b.Navigation("EmployeeClaimStatusExceptionReasonCategories");
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.EmployeeClient", b =>
                {
                    b.Navigation("ClientEmployeeDepartments");

                    b.Navigation("ClientEmployeeKpis");

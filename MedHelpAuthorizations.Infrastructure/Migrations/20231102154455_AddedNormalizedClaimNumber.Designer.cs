...
namespace MedHelpAuthorizations.Infrastructure.Migrations
{
    ...
    [Migration("20231102154455_AddedNormalizedClaimNumber")]
    partial class AddedNormalizedClaimNumber
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Application.Models.Chat.ChatHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.ClientFeeScheduleEntry", b =>
                {
                    ...
                    b.ToTable("ClientFeeScheduleEntries");
                });
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.ClientInsuranceFeeSchedule", b =>
                {
                    ...
                    b.ToTable("ClientInsuranceFeeSchedules");
                });
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.IntegratedServices.ClaimStatusBatchClaim", b =>
                {
                    ...
                    b.Property<string>("ClaimLevelMd5Hash")
                        ...
                        .HasComputedColumnSql("CONVERT([varchar](34), HASHBYTES('MD5', CONCAT(TRIM(CONVERT(varchar(12), PatientId)), '|', UPPER(ClaimNumber), '|', UPPER(ClientId), '|', UPPER(ClientInsuranceId), '|', CONVERT(varchar(8),DateOfServiceFrom, 112), '|')), 1)", true);
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Application.Models.Chat.ChatHistory", b =>
                {
                    b.HasOne("MedHelpAuthorizations.Application.Models.Identity.ApplicationUser", "FromUser")
                        .WithMany("ChatHistoryFromUsers")
                        .HasForeignKey("FromUserId");

                    b.HasOne("MedHelpAuthorizations.Application.Models.Identity.ApplicationUser", "ToUser")

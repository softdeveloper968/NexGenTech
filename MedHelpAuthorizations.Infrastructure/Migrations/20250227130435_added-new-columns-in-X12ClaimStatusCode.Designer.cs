...
namespace MedHelpAuthorizations.Infrastructure.Migrations
{
    ...
    [Migration("20250227130435_added-new-columns-in-X12ClaimStatusCode")]
    partial class addednewcolumnsinX12ClaimStatusCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.ClientDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.ClientEncounterType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("OldAuthTypeId")
                        .HasColumnType("int");

                    b.Property<int?>("OldClientAuthTypeId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ClientEncounterTypes");
                });
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.ClientInsurance", b =>
                {
                    ...
                    b.Property<bool>("AutoCalcPenalty")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.ClientNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.ClientUserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ClientUserNotifications");
                });
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.IntegratedServices.ApiClaimsMessageClaimLineitemStatusMap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ApiClaimsMessageClaimLineitemStatusMaps", "IntegratedServices");
                });
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.IntegratedServices.ClaimStatusBatch", b =>
                {
                    ...
                    b.Property<int?>("ClientEncounterTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClientEncounterTypeId");
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.IntegratedServices.X12ClaimStatusCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("X12ClaimStatusCodes", "IntegratedServices");
                });
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.MonthlyARData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("DenialGoal")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("DenialPercentageGoal")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("PercentageOfAR")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("decimal(18,2)")
                        .HasComputedColumnSql("CASE WHEN TotalReceivables = 0 THEN 0 ELSE (Receivables * 100) / TotalReceivables END");
                    ...
                    b.ToTable("MonthlyARData", "dbo");
                });

            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.MonthlyARSummary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MonthlyARSummaries");
                });

            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.MonthlyCashCollectionData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("CollectionGoal")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("MonthlyCashCollectionData");
                });

            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.MonthlyDenialData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("PercentageOfCharges")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("MonthlyDenialData");
                });

            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.MonthlyReceivablesData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MonthlyReceivablesData");
                });
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.PatientLedgerAdjustment", b =>
                {
                    ...
                    b.ToTable("PatientLedgerAdjustments", null, t =>
                        {
                            t.HasTrigger("trg_UpdateOutstandingBalance_OnAdjustments");
                        });
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.PatientLedgerCharge", b =>
                {
                    ...
                    b.Property<DateTime?>("InsuranceFirstBilledOn")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("InsuranceLastBilledOn")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("PatientLedgerCharges", null, t =>
                        {
                            t.HasTrigger("trg_UpdateOutstandingBalance_OnCharges");
                        });
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.PatientLedgerPayment", b =>
                {
                    ...
                    b.ToTable("PatientLedgerPayments", null, t =>
                        {
                            t.HasTrigger("trg_UpdateOutstandingBalance_OnPayments");
                        });
            ...
            modelBuilder.Entity("MedHelpAuthorizations.Domain.Entities.IntegratedServices.ClaimStatusBatch", b =>
                {
                    ...
                    b.HasOne("MedHelpAuthorizations.Domain.Entities.ClientEncounterType", null)
                        .WithMany("ClaimStatusBatches")
                        .HasForeignKey("ClientEncounterTypeId");

...
namespace MedHelpAuthorizations.Infrastructure.Persistence.Initialization
{
    public class ApplicationDbInitializer
    {
        ...
        public ApplicationDbInitializer(ApplicationContext dbContext, ITenantInfo currentTenant, ApplicationDbSeeder dbSeeder, ILogger<ApplicationDbInitializer> logger)
        {
        ...
        public async Task InitializeAsync(CancellationToken cancellationToken)
        {
            ...
            if (migrations.Any())
            {
                ...
                {
                    _logger.LogInformation("Applying Migrations for '{tenantId}' tenant.", _currentTenant.Identifier);

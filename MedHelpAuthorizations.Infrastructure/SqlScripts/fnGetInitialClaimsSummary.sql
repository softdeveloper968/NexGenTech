...
--)
--    DROP PROCEDURE [IntegratedServices].[fnGetInitialClaimsSummary]
--GO

CREATE OR ALTER   FUNCTION [IntegratedServices].[fnGetInitialClaimsSummary](
@ClientId int
...
RETURN
SELECT
SUM(c3.ChargedTotals) AS 'ChargedTotals'
,COUNT(DISTINCT(c3.ClaimLevelMd5Hash)) as 'TotalVisits'
,SUM(
    CASE 

...
CREATE OR ALTER   PROCEDURE [IntegratedServices].[spGetInitialClaimsSummaryTotals]
@ClientId int
...
(
    ...
    FROM 
        [IntegratedServices].[fnGetInitialClaimsSummary](
           @ClientId, 
...
CROSS JOIN (
    SELECT  
        ...
        NotAdjudicatedTotals
    FROM 
        [IntegratedServices].[fnGetInitialMonthlyClaimSummary](
            @ClientId, 
            @DelimitedLineItemStatusIds, 

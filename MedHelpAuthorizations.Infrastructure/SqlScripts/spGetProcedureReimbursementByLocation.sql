...
GO
CREATE OR ALTER  PROCEDURE [IntegratedServices].[spGetProcedureReimbursementByLocation]
@ClientId int
...
WHERE claimStatusBatchClaim.ClientId = @ClientId
		...
		, clientLocation.Id
		, TRIM(claimStatusBatchClaim.ProcedureCode),  claimStatusBatchClaim.ClaimLevelMd5Hash
	END

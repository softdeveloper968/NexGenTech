...
CREATE OR ALTER   PROCEDURE [IntegratedServices].[spGetReimbursementByProcedureCode]
@ClientId int
...
FROM [IntegratedServices].ClaimStatusBatchClaims as c1
	...
	LEFT JOIN [IntegratedServices].ClaimLineItemStatuses as claimLineItemStatus ON t.ClaimLineItemStatusId = claimLineItemStatus.Id
